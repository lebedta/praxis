...
//        print render($content);
        ...
        <?php if ($content['field_start_job_alter'][0]['#markup'] != ''): ?>
            <?php print render($content['field_start_job_alter']); ?>
        <?php else: ?>
        <?php print render($content['field_start_job']); ?>
        <?php endif; ?>
        <div class="posted-ago">(<?php print t('Job posted') ?>: <?php print t('%time ago', array('%time' => format_interval(time() - $created))); ?>)</div>
        <?php print render($content['field_last_date']); ?>
        <?php print render($content['field_salary']); ?>
        <?php print render($content['body']); ?>


        <div class="field field-name-field-email-job field-type-email field-label-hidden">
            <div class="field-items"><div class="field-item even">
                    <a href="mailto:<?php print $field_email_job[0]['email']; ?>"><?php print t('Apply now'); ?></a>
                </div>
            </div>
        </div>
